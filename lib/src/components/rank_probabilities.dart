...
class RankProbabilitiesComponent extends StatelessWidget {
  ...
  const RankProbabilitiesComponent(this._handBloc, {Key? key})
      : super(key: key);
                    ...
                    children: [
                      Table(children: [
                        _getTableRow(
                            "Straight Flush",
                            _handBloc
                                .hand.probability.probabilityToStraightFlush),
                        _getTableRow(
                            "Four of a Kind",
                            _handBloc
                                .hand.probability.probabilityToFourOfAKind),
                        _getTableRow("Full House",
                            _handBloc.hand.probability.probabilityToFullHouse),
                        _getTableRow("Flush",
                            _handBloc.hand.probability.probabilityToFlush),
                        _getTableRow("Straight",
                            _handBloc.hand.probability.probabilityToStraight),
                        _getTableRow(
                            "Three of a Kind",
                            _handBloc
                                .hand.probability.probabilityToThreeOfAKind),
                        _getTableRow("Two Pairs",
                            _handBloc.hand.probability.probabilityToTwoPairs),
                        _getTableRow("Pair",
                            _handBloc.hand.probability.probabilityToPair),
                        _getTableRow("High Card",
                            _handBloc.hand.probability.probabilityToHighCard)
                      ], border: _getTableBorder()),
                      Padding(
                        padding: const EdgeInsets.only(top: 10),
                        child: Table(children: [
                          _getTableRow(
                              "Win", _handBloc.hand.probability.winProbability),
                          _getTableRow(
                              "Tie", _handBloc.hand.probability.tieProbability),
                        ], border: _getTableBorder()),
                      )
                    ],
                  ),
